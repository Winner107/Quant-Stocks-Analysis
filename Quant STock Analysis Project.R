...
ggsave('stocks daily return chart.png')
...
ggsave('Cummulative return chart.png')
...
ggplot(cumulative_returns_long, aes(x = Date, y = value, color = variable)) +
  ...
  theme_minimal()
ggsave('Cummulative return chart 2.png')
...
ggsave('Sharpe ratio bar chart.png')
...
ggsave('Max drawdown bar chart.png')